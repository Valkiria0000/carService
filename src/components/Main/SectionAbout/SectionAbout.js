    ...
    <section className={classes.about} id="section1">
      <div className={classes.wrapper}>
        ...
        <div className={classes.block}>
          ...
          <p>
            Мы оказываем услуги по обслуживанию авто, шиномонтажу. Кроме того,
            мы можем заказать необходимые запчасти для Вашего автомобиля.
          </p>
        </div>
        <div className={classes.block}>
          <img src="./assets/img/icon/icon1.png" />
          <p>
            Техцентр «ГАРАЖ» (ГТГ) предлагает качественный ремонт автомобилей во
            Фрязино по приемлемым ценам. Также, возможен выезд мастера в удобное
            для Вас место.
          </p>
        </div>
        <br />
        <div className={classes.block}>
          ...
          <p>
            Мы профессионально ремонтируем машины всех марок. Для многих
            владельцев автомобилей наш автосервис является одним из немногих,
            где можно устранить практически любую неисправность..
          </p>
        </div>
        <br />
        <div className={classes.block}>
